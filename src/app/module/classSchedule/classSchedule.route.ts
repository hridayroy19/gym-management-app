...
classSchedulrouter.post(
  '/create',
  auth('ADMIN'),
  classScheduleControll.createSchedule
)
classSchedulrouter.get('/', classScheduleControll.getAllSchedules)
classSchedulrouter.patch(
  '/:id',
  auth('ADMIN'),
  classScheduleControll.updateSchedule
)
classSchedulrouter.delete(
  '/:id',
  auth('ADMIN'),
  classScheduleControll.deleteSchedule
)
